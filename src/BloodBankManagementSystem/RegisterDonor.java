...
public class RegisterDonor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Date - 14 Apr 2024     Venue - sector-14, Gurugram, Haryana.     Time - 7am to 7pm");
    ...
    private void registerBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerBtnActionPerformed
        ...
        try{
            ...
            PreparedStatement stat = conn.prepareStatement("insert into donationcampdonors  values(?,?,?,?,?,?)");
            stat.setString(1, name);
            stat.setString(2, dob);
            stat.setString(3, bloodGrp);
            stat.setString(4, mobileNo);
